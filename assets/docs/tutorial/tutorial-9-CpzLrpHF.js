import{U as w,f as C,d as y,P,I as T,L as m,V as E,e as z,R as b,G as o,c as r,B as k}from"../../tutorial-DguxYj_u-dU-97lk8.js";import{M as v,U as L}from"../../tutorial_shared-DEZC48XV-CtUk4EkX.js";import{u as S}from"../../web_cam_data_provider-CaGZ3nL9-Bzu_M5cH.js";/* empty css                              */v();const O=`
<div class="concept">
...
`;async function D(d,i=w,c){const f=i.clock??new C({...y,startPaused:i.paused,debug:!1,playback:{...y.playback,duration:1e4,isLoop:!0}}),x=c?.faceConfig;let p=c?.webCamProvider;p=p??new S(d,640,480);let l=c?.faceDataProvider;l=l??new P(d,{...x,baselineHeadPixels:120,baselineHeadSceneUnits:180,baseline:{x:0,y:0,z:0},cameraPosition:{x:0,y:0,z:300}});const g=new E(d),u={webCam:p,headTracker:l},t=new T(m.fromLibs({clock:f,loader:g,dataProviderLib:u}));t.startLoading(),t.enableDefaultPerspective(i.width,i.height,Math.PI/4,!0),i.paused&&t.pause(),t.loadPreset(z),t.addModifierToProjection("head",new b({disableRotation:!1,damping:.1}),"car");const n=200;for(let s=0;s<25;s++)t.addBox({id:`tunnel-${s}`,type:o.BOX,width:i.width,height:i.height,depth:10,strokeWidth:4,strokeColor:{red:255-s*10,green:255-s*10,blue:255-s*10},position:{x:0,y:50,z:-60*s}});var a=0;function e(s){a++,t.addBox({id:`target-${a}`,type:o.BOX,position:s,width:100}),t.addCylinder({id:`target-circle-${a}`,parentId:`target-${a}`,type:o.CYLINDER,radius:10/10,height:1,position:{x:0,y:50,z:-50},fillColor:r.red,rotate:{pitch:Math.PI/2,yaw:0,roll:0}}),t.addCylinder({id:`target-circle-1-${a}`,parentId:`target-${a}`,type:o.CYLINDER,radius:80/10,height:1,position:{x:0,y:50,z:-49.9},fillColor:r.white,rotate:{pitch:Math.PI/2,yaw:0,roll:0}}),t.addCylinder({id:`target-circle-2-${a}`,parentId:`target-${a}`,type:o.CYLINDER,radius:60/10,height:1,position:{x:0,y:50,z:-49.8},fillColor:r.red,rotate:{pitch:Math.PI/2,yaw:0,roll:0}}),t.addCylinder({id:`target-circle-3-${a}`,parentId:`target-${a}`,type:o.CYLINDER,radius:40/10,height:1,position:{x:0,y:50,z:-49.7},fillColor:r.white,rotate:{pitch:Math.PI/2,yaw:0,roll:0}}),t.addCylinder({id:`target-circle-4-${a}`,parentId:`target-${a}`,type:o.CYLINDER,radius:20/10,height:1,position:{x:0,y:50,z:-49.6},fillColor:r.red,rotate:{pitch:Math.PI/2,yaw:0,roll:0}}),t.addCylinder({id:`target-stick-${a}`,parentId:`target-${a}`,type:o.CYLINDER,height:100,radius:20/10,position:{x:0,y:50,z:-100.1},fillColor:{red:100,green:0,blue:0},rotate:{pitch:Math.PI/2,yaw:0,roll:0}})}e({x:0,y:0,z:0}),e({x:-70,y:-10,z:50}),e({x:50,y:10,z:80}),e({x:10,y:-80,z:30}),e({x:10,y:-200,z:10}),e({x:-30,y:30,z:90}),e({x:50,y:-50,z:70}),e({x:-30,y:-20,z:20}),e({x:-130,y:-120,z:200}),e({x:130,y:120,z:250}),e({x:200,y:200,z:400}),e({x:-200,y:-200,z:500}),e({x:-150,y:0,z:100}),e({x:150,y:0,z:120}),e({x:0,y:150,z:150}),e({x:0,y:-150,z:180}),e({x:-100,y:100,z:200}),e({x:100,y:-100,z:220}),e({x:-180,y:-50,z:300}),e({x:180,y:50,z:320}),e({x:50,y:180,z:350}),e({x:-50,y:-180,z:380}),e({x:-220,y:100,z:450}),e({x:220,y:-100,z:480}),e({x:100,y:200,z:520}),e({x:-100,y:-200,z:550}),e({x:60,y:0,z:-50}),e({x:-80,y:50,z:-30}),e({x:80,y:-50,z:-40}),e({x:0,y:-100,z:-20}),e({x:0,y:100,z:-10}),t.addBox({id:"center-cube",type:o.BOX,width:50,strokeWidth:1,strokeColor:r.white,position:{x:0,y:n,z:0},fillColor:r.red}),t.addBox({id:"left-cube",type:o.BOX,width:40,strokeWidth:1,strokeColor:r.white,position:{x:-150,y:n,z:-100},fillColor:r.blue}),t.addBox({id:"right-cube",type:o.BOX,width:40,strokeWidth:.1,strokeColor:r.white,position:{x:150,y:n,z:-100},fillColor:r.orange}),t.addBox({id:"far-cube",type:o.BOX,width:30,strokeWidth:1,strokeColor:r.white,position:{x:0,y:n,z:-300},fillColor:r.cyan}),t.addBox({id:"front-cube",type:o.BOX,width:30,strokeWidth:1,strokeColor:r.white,position:{x:0,y:n,z:-30},fillColor:r.purple});let h;return d.setup=()=>{d.createCanvas(i.width,i.height,d.WEBGL)},t.complete(),d.draw=async()=>{i.paused&&!t.isPaused()?t.pause():!i.paused&&t.isPaused()&&t.resume(),d.background(20),h&&(await t.step(h)).running},await l.init(),h=c?.graphicProcessor??new k(d,g),t}const I=`import p5 from 'p5';
...
`,_=/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>0,R=_?void 0:{throttleThreshold:0,videoWidth:640,videoHeight:480};L("tutorial-9","9. 3D Parallax Depth",D,I,O,{},R);
//# sourceMappingURL=tutorial-9-CpzLrpHF.js.map
