import{U as p,f as d,d as i,B as c,V as g,I as h,L as u,G as m}from"../../tutorial-DguxYj_u-dU-97lk8.js";import{M as y,U as b}from"../../tutorial_shared-DEZC48XV-CtUk4EkX.js";/* empty css                              */y();const f=`
<div class="concept">
...
`;async function k(t,o=p,n){let s;const l=o.clock??new d({...i,startPaused:o.paused,playback:{...i.playback,duration:5e3,isLoop:!0}}),a=new g(t);s=n?.graphicProcessor??new c(t,a);const e=new h(u.fromLibs({clock:l,loader:a}));return e.startLoading(),e.enableDefaultPerspective(o.width,o.height),o.paused&&e.pause(),e.addBox({type:m.BOX,id:"orbit-box",width:50,position:r=>({x:Math.cos(r.playback.progress*Math.PI*2)*50,y:Math.sin(r.playback.progress*Math.PI*2)*50,z:-100}),rotate:r=>({pitch:r.playback.progress*Math.PI,yaw:r.playback.progress*Math.PI*2,roll:0}),fillColor:{red:0,green:255,blue:150,alpha:1},strokeColor:{red:0,green:0,blue:255},strokeWidth:5}),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL),n?.graphicProcessor||(s=new c(t,a))},e.complete(),t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(s)).running},e}const P=`import p5 from 'p5';
...
`;b("tutorial-3","3. Orbital Motion",k,P,f);
//# sourceMappingURL=tutorial-3-BnTRitjW.js.map
