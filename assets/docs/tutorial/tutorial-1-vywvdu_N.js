import{U as c,f as d,d as a,B as p,V as h,I as u,L as g,G as m}from"../../tutorial-DguxYj_u-dU-97lk8.js";import{M as f,U as w}from"../../tutorial_shared-DEZC48XV-CtUk4EkX.js";/* empty css                              */f();const y=`
<div class="concept">
...
`;async function P(t,o=c,n){let r,e;const i=o.clock??new d({...a,startPaused:o.paused,playback:{...a.playback,duration:5e3,isLoop:!0}}),s=new h(t);return r=n?.graphicProcessor??new p(t,s),e=new u(g.fromLibs({clock:i,loader:s})),e.startLoading(),e.enableDefaultPerspective(o.width,o.height),o.paused&&e.pause(),e.addBox({type:m.BOX,id:"box",width:100,rotate:l=>({pitch:-.25*Math.PI,yaw:.25*Math.PI+Math.PI*2*l.playback.progress,roll:0}),position:{x:0,y:0,z:0},fillColor:{red:100,green:100,blue:255},strokeColor:{red:255,green:255,blue:255},strokeWidth:1}),e.complete(),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL)},t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(r)).running},e}const E=`import p5 from 'p5';
...
`;w("tutorial-1","1. Adding Elements",P,E,y);
//# sourceMappingURL=tutorial-1-vywvdu_N.js.map
