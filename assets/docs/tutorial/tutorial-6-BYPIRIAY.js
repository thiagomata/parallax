import{D as E,S as y,a as l,c as d,P as w,W as P,b as C,L,C as S,h as p,E as h}from"../../tutorial.template-XQYDx-t7.js";/* empty css                     */import{i as T,a as _}from"../../tutorial_shared-BUZHywJH.js";T();const A=`
<div class="concept">
...
`;async function b(t,o=E,n){let s;const f=o.clock??new y({...l,startPaused:o.paused,playback:{...l.playback,duration:1e4,isLoop:!0}}),r=new w(t);s=n?.graphicProcessor??new d(t,r);const u={look_at:L},e=new P(C.fromLibs({clock:f,loader:r,elementEffectLib:u}));return e.startLoading(),e.enableDefaultPerspective(o.width,o.height),e.loadPreset(S(t,{radius:300,verticalBaseline:100})),o.paused&&e.pause(),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL),n?.graphicProcessor||(s=new d(t,r)),e.addSphere({type:h.SPHERE,id:"obj",radius:20,position:c=>{const a=c.playback.progress*4*Math.PI,i=200,g=Math.sin(a)*i,k=Math.cos(a)*i,m=100+Math.sin(a*.5)*100;return{x:g,y:m,z:k}},rotate:{pitch:0,roll:0,yaw:0},fillColor:p.green,strokeColor:p.white,strokeWidth:1}),e.addCylinder({type:h.CYLINDER,id:"look-to-obj",radius:20,height:50,rotate:{yaw:0,roll:0,pitch:Math.PI/2},strokeWidth:2,position:{x:0,y:0,z:100},fillColor:{red:0,green:255,blue:0},strokeColor:{red:0,green:0,blue:255},effects:[{type:"look_at",settings:{lookAt:"obj",axis:{x:!0,y:!0,z:!0}}}]})},e.complete(),t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(s)).running},e}const x=`import p5 from 'p5';
...
`;_("tutorial-6","6. Objects Looking at Each Other",b,x,A);
//# sourceMappingURL=tutorial-6-BYPIRIAY.js.map
