import{U as h,f as g,d as i,B as d,V as u,I as m,L as y,G as c,M as l}from"../../tutorial-DguxYj_u-dU-97lk8.js";import{M as w,U as f}from"../../tutorial_shared-DEZC48XV-CtUk4EkX.js";/* empty css                              */w();const T=`
<div class="concept">
...
`;async function x(o,t=h,r){let a;const p=t.clock??new g({...i,startPaused:t.paused,playback:{...i.playback,duration:5e3,isLoop:!0}}),s=new u(o);a=r?.graphicProcessor??new d(o,s);const e=new m(y.fromLibs({clock:p,loader:s}));return e.startLoading(),e.enableDefaultPerspective(t.width,t.height),t.paused&&e.pause(),o.setup=async()=>{o.createCanvas(t.width,t.height,o.WEBGL),r?.graphicProcessor||(a=new d(o,s)),e.addBox({type:c.BOX,id:"textured-box",width:150,position:{x:0,y:0,z:-100},strokeWidth:0,rotate:n=>({pitch:0,yaw:Math.PI*2*n.playback.progress,roll:Math.PI*2*n.playback.progress}),texture:{path:l("img/target.png"),width:100,height:100}}),e.addText({type:c.TEXT,id:"title",text:"TEXTURES",size:30,position:{x:0,y:0,z:50},font:{name:"Roboto",path:l("fonts/Roboto-Regular.ttf")},fillColor:{red:0,green:229,blue:255}}),await s.waitForAllAssets()},e.complete(),o.draw=async()=>{t.paused&&!e.isPaused()?e.pause():!t.paused&&e.isPaused()&&e.resume(),o.background(15),(await e.step(a)).running},e}const P=`import p5 from 'p5';
...
`;f("tutorial-5","5. Loading Textures",x,P,T);
//# sourceMappingURL=tutorial-5-Cd9kvCpZ.js.map
