import{U as f,f as h,d as l,B as n,V as g,I as m,L as u,X as y,a as k,G as a,c}from"../../tutorial-DguxYj_u-dU-97lk8.js";import{M as w,U as E}from"../../tutorial_shared-DEZC48XV-CtUk4EkX.js";/* empty css                              */w();const P=`
<div class="concept">
...
`;async function b(t,o=f,i){let r;const d=o.clock??new h({...l,startPaused:o.paused,playback:{...l.playback,duration:1e4,isLoop:!0}}),s=new g(t);r=i?.graphicProcessor??new n(t,s);const p={look_at:y},e=new m(u.fromLibs({clock:d,loader:s,elementEffectLib:p}));return e.startLoading(),e.enableDefaultPerspective(o.width,o.height),e.loadPreset(k(t,{radius:300,verticalBaseline:100})),o.paused&&e.pause(),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL),i?.graphicProcessor||(r=new n(t,s)),e.addBox({id:"reference-cube",type:a.BOX,width:50,position:{x:150,y:0,z:0},fillColor:{red:100,green:100,blue:255},strokeColor:{red:255,green:255,blue:255},strokeWidth:3}),e.addPanel({id:"ref-panel",type:a.PANEL,position:{x:50,y:0,z:0},fillColor:{red:100,green:100,blue:255},strokeColor:{red:255,green:255,blue:255},width:50,height:50,strokeWidth:3}),e.addBox({id:"billboard-cube",type:a.BOX,width:50,position:{x:-150,y:0,z:0},fillColor:c.orange,strokeColor:{red:255,green:255,blue:255},effects:[{type:"look_at"}],rotate:{pitch:Math.PI/4,roll:Math.PI/4},strokeWidth:3}),e.addPanel({id:"billboard-panel",type:a.PANEL,width:50,height:50,position:{x:-50,y:0,z:0},fillColor:c.orange,strokeColor:{red:255,green:255,blue:255},effects:[{type:"look_at"}],strokeWidth:3})},e.complete(),t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(r)).running},e}const L=`import p5 from 'p5';
...
`;E("tutorial-7","7. Always Face Camera",b,L,P);
//# sourceMappingURL=tutorial-7-uaipVg8b.js.map
