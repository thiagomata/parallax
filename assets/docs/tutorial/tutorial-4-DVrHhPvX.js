import{b as l,p,U as m,f as h,d as f,B as c,V as g,I as u,L as w,a as P,G as b}from"../../tutorial-DguxYj_u-dU-97lk8.js";import{M as y,U as C}from"../../tutorial_shared-DEZC48XV-CtUk4EkX.js";/* empty css                              */y();Object.assign(window,{OrbitModifier:p,CenterFocusModifier:l});const k=`
<div class="concept">
...
`;async function v(r,o=m,n){let a;const d=o.clock??new h({...f,startPaused:o.paused}),i=new g(r);a=n?.graphicProcessor??new c(r,i);const e=new u(w.fromLibs({clock:d,loader:i}));return e.startLoading(),e.loadPreset(P(r,{radius:500})),e.enableDefaultPerspective(o.width,o.height),o.paused&&e.pause(),r.setup=()=>{r.createCanvas(o.width,o.height,r.WEBGL),n?.graphicProcessor||(a=new c(r,i));for(let s=0;s<5;s++)for(let t=0;t<5;t++)e.addBox({type:b.BOX,id:`box-${s}-${t}`,width:40,position:{x:(s-2)*100,y:0,z:200-t*100},fillColor:{red:s*50,green:255-s*50,blue:200}})},e.complete(),r.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),r.background(20),(await e.step(a)).running},e}const E=`import p5 from 'p5';
...
`;C("tutorial-4","4. Camera Control",v,E,k);
//# sourceMappingURL=tutorial-4-DVrHhPvX.js.map
