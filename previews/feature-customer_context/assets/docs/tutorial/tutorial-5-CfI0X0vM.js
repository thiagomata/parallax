import"../../modulepreload-polyfill-B5Qt9EMX.js";import{i as h}from"../../tutorial_shared-BvmHsNs7.js";import{D as u,S as g,a as i,P as d,b as m,W as y,c as w,E as c,e as l}from"../../head_tracking_data_provider-DGi6oQLX.js";const T=`
<div class="concept">
...
`;async function f(s,t=u,n){let a;const p=t.clock??new g({...i,startPaused:t.paused,playback:{...i.playback,duration:5e3,isLoop:!0}}),o=new m(s);a=n?.graphicProcessor??new d(s,o);const e=new y(w.fromLibs({clock:p,loader:o}));return e.startLoading(),e.enableDefaultPerspective(t.width,t.height),t.paused&&e.pause(),s.setup=async()=>{s.createCanvas(t.width,t.height,s.WEBGL),n?.graphicProcessor||(a=new d(s,o)),e.addBox({type:c.BOX,id:"textured-box",width:150,position:{x:0,y:0,z:-100},strokeWidth:0,rotate:r=>({pitch:0,yaw:Math.PI*2*r.playback.progress,roll:Math.PI*2*r.playback.progress}),texture:{path:l("img/target.png"),width:100,height:100}}),e.addText({type:c.TEXT,id:"title",text:"TEXTURES",size:30,position:{x:0,y:0,z:50},font:{name:"Roboto",path:l("fonts/Roboto-Regular.ttf")},fillColor:{red:0,green:229,blue:255}}),await o.waitForAllAssets()},e.complete(),s.draw=async()=>{t.paused&&!e.isPaused()?e.pause():!t.paused&&e.isPaused()&&e.resume(),s.background(15),(await e.step(a)).running},e}const x=`import p5 from 'p5';
...
`;h("tutorial-5","5. Loading Textures",f,x,T);
//# sourceMappingURL=tutorial-5-CfI0X0vM.js.map
