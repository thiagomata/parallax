import"../../modulepreload-polyfill-B5Qt9EMX.js";import{i as c}from"../../tutorial_shared-BvmHsNs7.js";import{D as d,S as p,a as n,P as h,b as u,W as m,c as g,E as f}from"../../head_tracking_data_provider-DGi6oQLX.js";const w=`
<div class="concept">
...
`;async function E(t,o=d,i){let r,e;const l=o.clock??new p({...n,startPaused:o.paused,playback:{...n.playback,duration:5e3,isLoop:!0}}),s=new u(t);return r=i?.graphicProcessor??new h(t,s),e=new m(g.fromLibs({clock:l,loader:s})),e.startLoading(),e.enableDefaultPerspective(o.width,o.height),o.paused&&e.pause(),e.addBox({type:f.BOX,id:"box",width:100,rotate:a=>({pitch:-.25*Math.PI,yaw:.25*Math.PI+Math.PI*2*a.playback.progress,roll:0}),position:{x:0,y:0,z:0},fillColor:{red:100,green:100,blue:255},strokeColor:{red:255,green:255,blue:255},strokeWidth:1}),e.complete(),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL)},t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(r)).running},e}const y=`import p5 from 'p5';
...
`;c("tutorial-1","1. Adding Elements",E,y,w);
//# sourceMappingURL=tutorial-1-BMdu5SSs.js.map
