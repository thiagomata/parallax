import"../../modulepreload-polyfill-B5Qt9EMX.js";import{i as m}from"../../tutorial_shared-BvmHsNs7.js";import{D as x,S as k,a as g,P as v,b as S,W as b,c as E,f as a,E as l,t as A}from"../../head_tracking_data_provider-DGi6oQLX.js";function d(n){const t=n.previousStore.global.keys??{};return t.ArrowUp||t.w||t.W?"up":t.ArrowDown||t.s||t.S?"down":t.ArrowLeft||t.a||t.A?"left":t.ArrowRight||t.d||t.D?"right":"idle"}function C(n){switch(n){case"up":return a.yellow;case"down":return a.pink;case"right":return a.orange;case"left":return a.lime;default:return a.white}}const L=`
<div class="concept">
...
`;async function P(n,t=x,w){let c,s,p=!1;const f=t.clock??new k({...g,startPaused:t.paused,playback:{...g.playback,duration:5e3,isLoop:!0}}),y=new S(n);c=w?.graphicProcessor??new v(n,y),s=new b(E.fromLibs({clock:f,loader:y})),s.startLoading(),s.enableDefaultPerspective(t.width,t.height),t.paused&&s.pause(),s.addBox({type:l.BOX,id:"box",width:60,height:60,depth:60,internal:{position:{x:0,y:0,z:-100},velocity:{x:0,y:0},speed:0},position:o=>{const e=o.element;e.position||(e.position={x:0,y:0,z:-100}),e.velocity||(e.velocity={x:0,y:0}),e.speed||(e.speed=0);const r=o.previousStore.global.keys??{},i=.4,h=.92;return(r.ArrowUp||r.w||r.W)&&(e.velocity.y-=i),(r.ArrowDown||r.s||r.S)&&(e.velocity.y+=i),(r.ArrowLeft||r.a||r.A)&&(e.velocity.x-=i),(r.ArrowRight||r.d||r.D)&&(e.velocity.x+=i),e.velocity.x*=h,e.velocity.y*=h,e.position.x+=e.velocity.x,e.position.y+=e.velocity.y,e.speed=Math.sqrt(e.velocity.x**2+e.velocity.y**2),{x:e.position.x,y:e.position.y,z:e.position.z}},fillColor:o=>C(d(o)),strokeColor:a.red,strokeWidth:2}),s.addText({type:l.TEXT,id:"title",text:"Use the keyboard arrows.",size:10,position:{x:0,y:-50,z:0},font:{name:"Roboto",path:"/parallax/fonts/Roboto-Regular.ttf"},fillColor:a.lime}),s.addPanel({type:l.PANEL,id:"arrow",parentId:"box",width:10,height:10,rotate:{pitch:0,yaw:0,roll:o=>{const e=d(o);return e==="up"?0:e==="down"?Math.PI:e==="left"?-Math.PI/2:e==="right"?Math.PI/2:0}},position:{x:0,y:0,z:31},texture:A({default:"target",variants:{target:{path:"/parallax/img/target.png",width:100,height:100},arrow:{path:"/parallax/img/arrow.png",width:100,height:100}},select:o=>d(o)==="idle"?"target":"arrow"})}),s.complete();const u=(o,e)=>{const r=s.getExternalStore();r.global=r.global??{},r.global.keys=r.global.keys??{},r.global.keys[o]=e};return typeof window<"u"&&(window.addEventListener("keydown",o=>{["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," ","Spacebar"].includes(o.key)&&(o.preventDefault(),o.stopPropagation()),u(o.key,!0)},{passive:!1}),window.addEventListener("keyup",o=>{["ArrowUp","ArrowDown","ArrowLeft","ArrowRight"," ","Spacebar"].includes(o.key)&&(o.preventDefault(),o.stopPropagation()),u(o.key,!1)},{passive:!1})),n.setup=()=>{n.createCanvas(t.width,t.height,n.WEBGL),p=!0},n.draw=async()=>{if(t.paused&&!s.isPaused()?s.pause():!t.paused&&s.isPaused()&&s.resume(),n.background(20),p){if(n.push(),n.translate(0,0,100),!(await s.step(c)).running)return;n.pop()}},s}const T=`import p5 from 'p5';
...
`;m("tutorial-10","10. Interactive Box Control",P,T,L);
//# sourceMappingURL=tutorial-10-D9z9QiTE.js.map
