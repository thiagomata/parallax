import"../../modulepreload-polyfill-B5Qt9EMX.js";import{L as f,i as h}from"../../tutorial_shared-BvmHsNs7.js";import{D as u,S as m,a as i,P as n,b as g,W as E,c as y,d as k,E as r,f as c}from"../../head_tracking_data_provider-DGi6oQLX.js";const w=`
<div class="concept">
...
`;async function P(t,o=u,l){let a;const d=o.clock??new m({...i,startPaused:o.paused,playback:{...i.playback,duration:1e4,isLoop:!0}}),s=new g(t);a=l?.graphicProcessor??new n(t,s);const p={look_at:f},e=new E(y.fromLibs({clock:d,loader:s,elementEffectLib:p}));return e.startLoading(),e.enableDefaultPerspective(o.width,o.height),e.loadPreset(k(t,{radius:300,verticalBaseline:100})),o.paused&&e.pause(),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL),l?.graphicProcessor||(a=new n(t,s)),e.addBox({id:"reference-cube",type:r.BOX,width:50,position:{x:150,y:0,z:0},fillColor:{red:100,green:100,blue:255},strokeColor:{red:255,green:255,blue:255},strokeWidth:3}),e.addPanel({id:"ref-panel",type:r.PANEL,position:{x:50,y:0,z:0},fillColor:{red:100,green:100,blue:255},strokeColor:{red:255,green:255,blue:255},width:50,height:50,strokeWidth:3}),e.addBox({id:"billboard-cube",type:r.BOX,width:50,position:{x:-150,y:0,z:0},fillColor:c.orange,strokeColor:{red:255,green:255,blue:255},effects:[{type:"look_at"}],rotate:{pitch:Math.PI/4,roll:Math.PI/4},strokeWidth:3}),e.addPanel({id:"billboard-panel",type:r.PANEL,width:50,height:50,position:{x:-50,y:0,z:0},fillColor:c.orange,strokeColor:{red:255,green:255,blue:255},effects:[{type:"look_at"}],strokeWidth:3})},e.complete(),t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(a)).running},e}const b=`import p5 from 'p5';
...
`;h("tutorial-7","7. Always Face Camera",P,b,w);
//# sourceMappingURL=tutorial-7-QVJYoLzJ.js.map
