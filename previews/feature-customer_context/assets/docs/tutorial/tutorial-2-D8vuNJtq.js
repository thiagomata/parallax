import"../../modulepreload-polyfill-B5Qt9EMX.js";import{T as s,i as p}from"../../tutorial_shared-BvmHsNs7.js";import{D as d,S as u,a as i,b as m,P as f,W as h,c as g,E as y}from"../../head_tracking_data_provider-DGi6oQLX.js";const k=`
<div class="concept">
...
`;async function E(r,o=d,l){let a;const c=o.clock??new u({...i,startPaused:o.paused,playback:{...i.playback,duration:5e3,isLoop:!0}}),n=o.loader??new m(r);a=l?.graphicProcessor??new f(r,n);const t=new h(g.fromLibs({clock:c,loader:n,elementEffectLib:{[s.type]:s}}));return t.startLoading(),t.enableDefaultPerspective(o.width,o.height),o.paused&&t.pause(),r.setup=()=>{r.createCanvas(o.width,o.height,r.WEBGL),t.addBox({type:y.BOX,id:"pulsing-box",position:{x:0,y:0,z:0},width:e=>100+Math.sin(e.playback.progress*Math.PI*2)*50,rotate:e=>({pitch:0,yaw:Math.PI*2*e.playback.progress,roll:Math.PI*2*e.playback.progress}),fillColor:{red:255,green:100,blue:e=>127+127*Math.cos(Math.PI*2*e.playback.progress),alpha:1},strokeWidth:5,effects:[{type:s.type,settings:{transform:(e,P)=>({...e,strokeColor:{red:255-(e.fillColor?.red??0),green:255-(e.fillColor?.green??0),blue:255-(e.fillColor?.blue??0),alpha:1}})}}]})},t.complete(),r.draw=async()=>{o.paused&&!t.isPaused()?t.pause():!o.paused&&t.isPaused()&&t.resume(),r.background(20),(await t.step(a)).running},t}const b=`import p5 from 'p5';
...
`;p("tutorial-2","2. Animation Over Time",E,b,k);
//# sourceMappingURL=tutorial-2-D8vuNJtq.js.map
