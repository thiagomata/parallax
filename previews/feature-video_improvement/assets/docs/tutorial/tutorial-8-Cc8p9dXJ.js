    ...
    p.draw = async () => {
        ...
        if (!initialized) {
            ...
            world.addPanel({
                ...
                height: 1080 * 3,
                fitMode: "contain",
                position: { x: 0, y: 0, z: -500 * 3 },
                video: (ctx: ResolutionContext<ObserverDataProviderLib>) => {
                    const webCam = ctx.dataProviders['webCam'] as unknown as WebCamDataProvider | undefined;
                    if (webCam && typeof webCam.getStatus === 'function' && webCam.getStatus() === 'READY') {
                        return null;
                    }
                    return resolvePreferredSource(ctx.dataProviders, VIDEO_SOURCE_ORDER);
                },
...
`,N=/Android|iPhone|iPad|iPod/i.test(navigator.userAgent)||navigator.maxTouchPoints>0,A=N?void 0:{throttleThreshold:0,videoWidth:640,videoHeight:480};z("tutorial-8","8. The Observer",W,M,D,{},A);
//# sourceMappingURL=tutorial-8-Cc8p9dXJ.js.map
