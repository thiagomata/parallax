import{D as l,S as c,a as n,W as p,b as h,P as u,E as i,c as g}from"../../tutorial.template-BtbKL_rn.js";/* empty css                     */import{i as m,a as y}from"../../tutorial_shared-oNg0pm32.js";m();const w=`
<div class="concept">
...
`;async function T(o,t=l){let r;const d=t.clock??new c({...n,startPaused:t.paused,playback:{...n.playback,duration:5e3,isLoop:!0}}),s=new u(o),e=new p(h.fromLibs({clock:d,loader:s}));return e.startLoading(),e.enableDefaultPerspective(t.width,t.height),t.paused&&e.pause(),o.setup=async()=>{o.createCanvas(t.width,t.height,o.WEBGL),r=new g(o,s),e.addBox({type:i.BOX,id:"textured-box",width:150,position:{x:0,y:0,z:-100},strokeWidth:0,rotate:a=>({pitch:0,yaw:Math.PI*2*a.playback.progress,roll:Math.PI*2*a.playback.progress}),texture:{path:"/parallax/img/target.png",width:100,height:100}}),e.addText({type:i.TEXT,id:"title",text:"TEXTURES",size:30,position:{x:0,y:0,z:50},font:{name:"Roboto",path:"/parallax/fonts/Roboto-Regular.ttf"},fillColor:{red:0,green:229,blue:255}}),await s.waitForAllAssets()},e.complete(),o.draw=async()=>{t.paused&&!e.isPaused()?e.pause():!t.paused&&e.isPaused()&&e.resume(),o.background(15),(await e.step(r)).running},e}const f=`import p5 from 'p5';
...
`;y("tutorial-5","5. Loading Textures",T,f,w);
//# sourceMappingURL=tutorial-5-C-aE5zRF.js.map
