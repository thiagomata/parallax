import{D as c,S as p,a as i,P as d,W as u,b as m,T as a,E as f,c as h}from"../../tutorial.template-Di1W94te.js";/* empty css                     */import{i as g,a as y}from"../../tutorial_shared-CQvwV1kY.js";g();const k=`
<div class="concept">
...
`;async function E(r,o=c){let s;const l=o.clock??new p({...i,startPaused:o.paused,playback:{...i.playback,duration:5e3,isLoop:!0}}),n=o.loader??new d(r);s=new h(r,n);const t=new u(m.fromLibs({clock:l,loader:n,elementEffectLib:{[a.type]:a}}));return t.startLoading(),t.enableDefaultPerspective(o.width,o.height),o.paused&&t.pause(),r.setup=()=>{r.createCanvas(o.width,o.height,r.WEBGL),t.addBox({type:f.BOX,id:"pulsing-box",position:{x:0,y:0,z:0},width:e=>100+Math.sin(e.playback.progress*Math.PI*2)*50,rotate:e=>({pitch:0,yaw:Math.PI*2*e.playback.progress,roll:Math.PI*2*e.playback.progress}),fillColor:{red:255,green:100,blue:e=>127+127*Math.cos(Math.PI*2*e.playback.progress),alpha:1},strokeWidth:5,effects:[{type:a.type,settings:{transform:(e,P)=>({...e,strokeColor:{red:255-(e.fillColor?.red??0),green:255-(e.fillColor?.green??0),blue:255-(e.fillColor?.blue??0),alpha:1}})}}]})},t.complete(),r.draw=async()=>{o.paused&&!t.isPaused()?t.pause():!o.paused&&t.isPaused()&&t.resume(),r.background(20),(await t.step(s)).running},t}const b=`import p5 from 'p5';
...
`;y("tutorial-2","2. Animation Over Time",E,b,k);
//# sourceMappingURL=tutorial-2-BI5BVRY0.js.map
