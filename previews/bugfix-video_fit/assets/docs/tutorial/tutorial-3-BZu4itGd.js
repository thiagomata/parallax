import{D as l,S as c,a as n,W as p,b as d,P as g,E as u,c as h}from"../../tutorial.template-PYpWsMkT.js";/* empty css                     */import{i as m,a as y}from"../../tutorial_shared-CSHlWac9.js";m();const b=`
<div class="concept">
...
`;async function f(t,o=l){let s;const i=o.clock??new c({...n,startPaused:o.paused,playback:{...n.playback,duration:5e3,isLoop:!0}}),a=new g(t),e=new p(d.fromLibs({clock:i,loader:a}));return e.startLoading(),e.enableDefaultPerspective(o.width,o.height),o.paused&&e.pause(),e.addBox({type:u.BOX,id:"orbit-box",width:50,position:r=>({x:Math.cos(r.playback.progress*Math.PI*2)*50,y:Math.sin(r.playback.progress*Math.PI*2)*50,z:-100}),rotate:r=>({pitch:r.playback.progress*Math.PI,yaw:r.playback.progress*Math.PI*2,roll:0}),fillColor:{red:0,green:255,blue:150,alpha:1},strokeColor:{red:0,green:0,blue:255},strokeWidth:5}),t.setup=()=>{t.createCanvas(o.width,o.height,t.WEBGL),s=new h(t,a)},e.complete(),t.draw=async()=>{o.paused&&!e.isPaused()?e.pause():!o.paused&&e.isPaused()&&e.resume(),t.background(20),(await e.step(s)).running},e}const k=`import p5 from 'p5';
...
`;y("tutorial-3","3. Orbital Motion",f,k,b);
//# sourceMappingURL=tutorial-3-BZu4itGd.js.map
