...
describe('Tutorial 5 Execution Test: Assets & Hydration', () => {
    ...
    it('should correctly initialize the world and hydrate assets when executed', async () => {
        // Setup Mock p5 with immediate callback triggers
        const mockP5 = createMockP5();
        // Execute the tutorial
        const world = tutorial_5(mockP5 as unknown as p5);

        // TRIGGER setup (Awaiting the loader.waitForAllAssets() inside)
        await mockP5.setup();

        // Verify Registration & Hydration
        ...
        // Verify Execution - (P5 Side Effects)
    ...
    it('should verify the full bridge pipeline (Assets -> Processor -> P5)', async () => {
        ...
        // Complete Registration & Hydration
        await mockP5.setup();

        // Trigger The Frame Loop
        mockP5.draw();
